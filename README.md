...
detector = HybridPIIDetector()  # NER модель по умолчанию загружается с HF: alrosait/spacy_ru_core_news_lg_pii
...
|-------------------|------------|------------|------------|------|----|----|
| ADDRESS           | 0.8239     | 0.8239     | 0.8239     | 145  | 31 | 31 |
...
| NAME              | 0.9677     | 0.9211     | 0.9438     | 213  | 7  | 18 |
...
| NAME              | 0.9887     | 0.9398     | 0.9636     | 3059       | 35         | 196        |
...
| **\_MACRO\_**     | **0.9936** | **0.9791** | **0.9862** | 29927      | 332        | 857        |
